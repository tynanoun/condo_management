                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="task_name" parsley-trigger="change" required="" class="form-control" id="task_name">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control datepicker" placeholder="mm/dd/yyyy" id="start_date" name="start_date" required="">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control datepicker" placeholder="mm/dd/yyyy" id="end_date" name="end_date" required="">
                                            <span class="input-group-addon bg-custom b-0"><i class="mdi mdi-calendar text-white"></i></span>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control parsley-error" name="description"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group">
